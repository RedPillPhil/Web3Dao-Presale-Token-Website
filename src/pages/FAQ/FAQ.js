...
const FAQs = {
  1: { text: '$ART is an ERC20 token that serves as the fuel for the BusinessNetwork protocol, which is an image and video generation network. It is used to pay for generated images and can be earned by contributing GPU power to the network.' },
